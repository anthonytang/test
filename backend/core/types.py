...
class DisplayType(str, Enum):
    """Viewer type for file display."""
    DOCUMENT = "document"  # DocumentViewer - bounding box highlighting
    TABLE = "table"        # TableViewer - cell highlighting
    TEXT = "text"          # TextViewer - text highlighting
