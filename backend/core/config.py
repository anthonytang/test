...
AZURE_STORAGE_CONTAINER_NAME = os.getenv("AZURE_STORAGE_CONTAINER_NAME", "user-files")
...
COSMOS_DATABASE_NAME = os.getenv("COSMOS_DATABASE_NAME", "vectordb")
...
TABLE_MAX_TOKENS_PER_CHUNK = 8000
...
FIELD_PROCESSING_CONCURRENCY = 5
URL_CRAWL_CONCURRENCY = 5
