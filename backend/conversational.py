...
class Conversational:
    ...
    async def parse_template_request(
        ...
        if 'template' not in parsed:
            raise ValueError("Response missing 'template' structure")
        if 'sections' not in parsed:
            raise ValueError("Response missing 'sections' structure")
    ...
    async def refine_section_description(
        ...
        if not result:
            raise ValueError("Empty response from enhancement")
