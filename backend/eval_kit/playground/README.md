...
File Upload (optional)
    ↓
Document Parsing (Azure Document Intelligence, Gotenberg)
    ↓
...
- **PDF** - Parsed using Azure Document Intelligence
- **Word/PowerPoint** - Converted to PDF via Gotenberg, then parsed
